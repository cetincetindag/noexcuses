...
function TabsContent({
  ...
  return (
    <TabsPrimitive.Content
      ...
      className={cn("bg-background flex-1 outline-none", className)}
      {...props}
    />
  );
}
